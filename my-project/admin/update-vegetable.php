...
<?php 
    ...
    {
        $id = $_GET['id'];
        $sql2 = "SELECT * FROM tbl_goods WHERE id=$id";
        ...
        <table class="tbl-30">
            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        {
                            ?>
                            <img src="<?php echo SITEURL; ?>images/vegetable/<?php echo $current_image; ?>" width="150px">
                            <?php
                        }
                    ?>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Vegetable" class="btn-secondary">
                </td>
            </tr>
